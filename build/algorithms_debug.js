...
function __debug_palindrome_forward_recursive(f, n, r) {
...
function palindrome_forward_recursive(f, n, r) {
    var _f_ = start_f('palindrome_forward_recursive', f, n, r);
    var res = __debug_palindrome_forward_recursive(f, n, r);
    end_f(_f_);
    return res;
}
